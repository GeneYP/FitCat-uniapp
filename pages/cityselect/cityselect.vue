<template>
	<view>
		<view class="input">
			<input placeholder="输入城市名或拼音查询" placeholder-style="font-size: 28rpx" :value="inputName"
		...
		<view class="container-inner">
			<view class="searchLetter touchClass">
				<view class="thishotText" @click="hotCity">
					<!-- <view style="margin-top:10;font-size:28rpx;">当前</view> -->
					<view style="margin-top:10;font-size:28rpx;">热门</view>
				</view>
				<view v-for="(item, idx) in searchLetter" :key="idx" style="color:#000000;font-size:28rpx;"
			...
			<view class="container">
				...
				<scroll-view scroll-y="true" v-bind:style="{height: winHeight + 'px'}" :scroll-into-view="scrollTopId">
					...
					<view class="selectCity">
						<view class="hotcity-common" @click="reGetLocation" id="currentcity">
							<u-icon name="map"></u-icon>当前定位城市
						</view>
						...
						<view class="hotcity-common"><u-icon name="star-fill"></u-icon>热门城市</view>
						<view class="weui-grids">
							<view class="weui-grid" :data-code="440800" data-city="湛江市" @click="bindCity">
								<view class="weui-grid__label">湛江市</view>
							</view>
						...
						<view class="weui-grids">
							<view class="weui-grid" :data-code="350200" data-city="厦门市" @click="bindCity">
								<view class="weui-grid__label">厦门市</view>
							</view>
							<view class="weui-grid" :data-code="350100" data-city="福州市" @click="bindCity">
								<view class="weui-grid__label">福州市</view>
							</view>
							<view class="weui-grid" :data-code="440600" data-city="佛山市" @click="bindCity">
								<view class="weui-grid__label">佛山市</view>
							</view>
						</view>
					</view>
